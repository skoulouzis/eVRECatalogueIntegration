...
#    print(all_vars)
    ...
    data= """
            ...
            var:bytes tmpl:2dvalue_1_0 1231
            var:url tmpl:2dvalue_1_0 /cue/rest/?wadl
            var:method tmpl:2dvalue_1_0 GET
            var:version tmpl:2dvalue_1_0 1.1
            var:time tmpl:value_1 2018-09-13T12:51:04+00:00

            var:agent tmpl:value_2 vre:ag2
            var:ip tmpl:2dvalue_2_0 10.255.0.2
            var:status tmpl:2dvalue_2_0 200
            var:bytes tmpl:2dvalue_2_0 28172
            var:url tmpl:2dvalue_2_0 /cue/rest/argo/get?geospatial_lat_min=31.000&geospatial_lat_max=38.200&geospatial_lon_min=147.000&geospatial_lon_max=147.100&flowlabel=
            var:method tmpl:2dvalue_2_0 GET
            var:version tmpl:2dvalue_2_0 1.1
            var:time tmpl:value_2 2018-09-13T12:51:13+00:00

            var:agent tmpl:value_3 vre:ag3
            var:ip tmpl:2dvalue_3_0 10.255.0.2
            var:status tmpl:2dvalue_3_0 200
            var:bytes tmpl:2dvalue_3_0 1103475
            ...
            var:time tmpl:value_3 2018-09-13T13:12:56+00:00

            var:agent tmpl:value_4 vre:ag4
            var:ip tmpl:2dvalue_4_0 10.255.0.2
            var:status tmpl:2dvalue_4_0 200
            var:bytes tmpl:2dvalue_4_0 319806
            var:url tmpl:2dvalue_4_0 /cue/rest/argo/get?geospatial_lat_min=31.000
            var:method tmpl:2dvalue_4_0 GET
            var:version tmpl:2dvalue_4_0 1.1
            var:time tmpl:value_4 2018-09-13T13:12:58+00:00
            ...
            var:time tmpl:value_5 2018-09-13T13:13:50+00:00

            var:agent tmpl:value_6 vre:ag6
            var:ip tmpl:2dvalue_6_0 10.255.0.2
            var:status tmpl:2dvalue_6_0 200
            var:bytes tmpl:2dvalue_6_0 28172
            var:url tmpl:2dvalue_6_0 /cue/rest/argo/get?geospatial_lat_min=31.000&geospatial_lat_max=38.200&geospatial_lon_min=147.000&geospatial_lon_max=147.100
            var:method tmpl:2dvalue_6_0 GET
            var:version tmpl:2dvalue_6_0 1.1
            var:time tmpl:value_6 2018-09-13T13:13:51+00:00
